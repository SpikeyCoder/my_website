function loadScript(e,n){return new Promise((t,r)=>{const i=n?`script[src="${e}"][integrity="${n}"]`:`script[src="${e}"]`;if(document.querySelector(i))return void t();const o=document.createElement("script");o.src=e;if(n){o.integrity=n;o.crossOrigin="anonymous";o.referrerPolicy="no-referrer";}o.onload=t;o.onerror=r;document.head.appendChild(o)})}async function loadBlogDeps(){await Promise.all([loadScript("https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.49.4/dist/umd/supabase.js","sha384-rwykjmWNwVxboyFmvK9OXN0wj9hnMHA2aAHtits54DuACyCq0M2PrSNxhRb+hvXT"),loadScript("https://cdn.jsdelivr.net/npm/dompurify@3.0.11/dist/purify.min.js","sha384-Ic7KEGROu37YaruU6NyiYeib7UhjFyDZQ5fzBAji965L75T/4LGk5nzwMEjNGexs"),loadScript("https://cdn.jsdelivr.net/npm/marked@12.0.2/marked.min.js","sha384-/TQbtLCAerC3jgaim+N78RZSDYV7ryeoBCVqTuzRrFec2akfBkHS7ACQ3PQhvMVi")])}function escapeHtml(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}document.body.classList.add("js"),window.setupBlogPostToggles=function(e){e&&e.querySelectorAll(".blog-toggle").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.post,o=e.querySelector(`[data-content='${n}']`);o&&(o.classList.toggle("open"),t.textContent=o.classList.contains("open")?"Close":"Read")})})};const adminToggle=document.getElementById("admin-toggle"),adminPanel=document.getElementById("admin-panel"),adminClose=document.getElementById("admin-close");adminToggle&&adminPanel&&adminToggle.addEventListener("click",()=>{adminPanel.hidden=!1,adminPanel.style.display="grid"}),adminClose&&adminPanel&&adminClose.addEventListener("click",()=>{adminPanel.hidden=!0,adminPanel.style.display="none"}),adminPanel&&adminPanel.addEventListener("click",e=>{e.target===adminPanel&&(adminPanel.hidden=!0,adminPanel.style.display="none")});
